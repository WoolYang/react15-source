...
var ReactTestComponent = function () {
  ...
  ReactTestComponent.prototype.getPublicInstance = function getPublicInstance() {
    ...
    !hostContainerInfo ? process.env.NODE_ENV === 'development' ? invariant(false, 'hostContainerInfo should be populated before getPublicInstance is called.') : _prodInvariant('145') : void 0;
